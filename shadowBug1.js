...
//bug database
const { shadowtext1 } = require('./69/shadowtext1')
const { shadowtext2 } = require('./69/shadowtext2')
const { shadowtext3 } = require('./69/shadowtext3')
const { shadowtext4 } = require('./69/shadowtext4')
const { shadowtext5 } = require('./69/shadowtext5')
const { shadowtext6 } = require('./69/shadowtext6')
const { shadowtext7 } = require('./69/shadowtext7')
const { shadowtext8 } = require('./69/shadowtext8')
const { shadowtext9 } = require('./69/shadowtext9')
const { shadowtext10 } = require('./69/shadowtext10')
...
"previewType": "PHOTO",
"thumbnailUrl": ``,
"thumbnail": fs.readFileSync(`./SHADOWMedia/thumb.jpg`),
"sourceUrl": `${link}`}}},
{ quoted: m})
}
...
mimetype: `image/null`,
fileName: `${dgxeon}.${shadowtext4}` ,
caption: `${dgxeon + shadowtext4}`,
